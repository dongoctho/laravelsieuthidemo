            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="add-bottom-3">
                        ...
                        <div class="nhapten">
                            ...
                            <select name="payment" class="txtTen1">
                ...
                <div class="add-bottom-3">
                    ...
                    <div class="nhapten">
                        ...
                        <input type="text" name="total" class="txtTen1" disabled>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laraveldemoabc\resources\views/admin/order/add-order.blade.php ENDPATH**/ ?>